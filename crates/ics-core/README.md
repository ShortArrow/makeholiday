...
formatter shared by the [makeholiday] ecosystem:

- [`icscli`](https://crates.io/crates/icscli) — general-purpose ICS CLI (currently developed in-tree as `makeholiday`).
...
This `0.0.0` placeholder reserves the name on crates.io while
development continues toward the first real release (v0.2.0).
